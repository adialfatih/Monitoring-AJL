...
<head>
    ...
    <meta name="application-name" content="AJL Data">
    <meta name="apple-mobile-web-app-title" content="AJL Data">
    <meta name="theme-color" content="#246cd1">
    <meta name="msapplication-navbutton-color" content="#246cd1">
    <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
    <meta name="msapplication-starturl" content="https://ajl.rdgjt.com">
    <link rel="apple-touch-icon" sizes="180x180" href="https://ajl.rdgjt.com/assets/logo_rjs2.jpg"/>
		<link rel="icon" type="image/png" sizes="32x32" href="https://ajl.rdgjt.com/assets/logo_rjs2.jpg"/>
		<link rel="icon" type="image/png" sizes="16x16" href="https://ajl.rdgjt.com/assets/logo_rjs2.jpg"/>
...
<body>
    ...
    <div class="login-container">
    <form class="form_container" action="<?=base_url('operator/proseslogin');?>" method="post">
        <div class="logo_container"><img src="<?=base_url('assets/');?>logo_rjs2.jpg" alt="Logo RJS"></div>
        <div class="title_container">
          <p class="title">Login Operator</p>
          <span class="subtitle">Masukan username dan password untuk login Operator mesin AJL</span>
        </div>
        <br>
        <div class="input_container">
          ...
          <input placeholder="Username" title="Inpit title" name="user" type="text" class="input_field" id="email_field" required>
        </div>
        <div class="input_container">
        ...
        <p class="note">&copy; Departement IT RJS</p>
      </form>
    </div>
